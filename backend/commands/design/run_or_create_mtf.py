"""
Generate Run or Create MTF command
"""
...
def run_or_create_mtf_command(prefix: str, cell_value: str) -> List[str]:
    ...
    xml_string = rf"""
      <If_function_exists>
        <Name>If function {cell_value} mtf Exists</Name>
        <Active>true</Active>
        ...
        <Conditional>
          ...
          <Pass_Action>RUN {cell_value} mtf FILE</Pass_Action>
          <Fail_Mode>1</Fail_Mode>
          <Fail_Action>CREATE {cell_value} mtf FILE</Fail_Action>
        </Conditional>
        <Function>{cell_value} mtf</Function>
      </If_function_exists>
      <Label>
        <Name>CREATE {cell_value} mtf FILE</Name>
        <Active>true</Active>
        <Continue_on_failure>false</Continue_on_failure>
        <Uses_parameters>false</Uses_parameters>
        <Interactive>false</Interactive>
      ...
      <Run_option>
        ...
        <SLF_data>
          <screen_layout>
            ...
            <panel>
              ...
              <file_box>
                <name>File</name>
                <value>{cell_value} template.tpl</value>
              </file_box>
              <run_button>
                <name>&amp;Read</name>
              </run_button>
        ...
        <record_name>Read Templates</record_name>
        <Parameter_Mappings>
        </Parameter_Mappings>
      </Run_option>
  ...
  <panel>
    ...
    <widget_pages>
      ...
      <widget_page>
        ...
        <file_box>
          <name>MTF file</name>
          <value>{cell_value} mtf.mtf</value>
        </file_box>
        <tick_box>
        ...
        <select_box>
          <name>Reference</name>
          <value>
            <cell_value>{prefix}/{cell_value}</cell_value>
            <model_id></model_id>
        ...
        <file_box>
          ...
          <value>volumes {cell_value} mtf.rpt</value>
        </file_box>
      </widget_page>
      <widget_page>
        <name>Models</name>
        <grid_box>
          ...
          <data>
            <r><c>{prefix}/{cell_value} Strs</c><c>{prefix}/{cell_value} Sctn</c><c>red</c></r>
            <r><c></c><c></c><c></c></r>
            <r><c></c><c></c><c></c></r>
            <r><c></c><c></c><c></c></r>
            <r><c></c><c></c><c></c></r>
        ...
        <input_box>
          ...
          <value>{prefix}/{cell_value} Poly</value>
        </input_box>
        <input_box>
          <name>Model for road boundary</name>
          <value>{prefix}/{cell_value} Bdy</value>
        </input_box>
      </widget_page>
      <widget_page>
        <name>Misc</name>
      ...
      <widget_page>
        ...
        <input_box>
          ...
          <value>tin/tin {cell_value} mtf</value>
        </input_box>
        <tick_box>
        ...
        <input_box>
          <name>Model for polygons</name>
          <value>Apply/VIS Depth Polygons/{cell_value} mtf</value>
        </input_box>
        <grid_box>
      ...
      <widget_page>
        ...
        <input_box>
          ...
          <value>Apply/Sections/Filtered/{cell_value} mtf</value>
        </input_box>
        <input_box>
      ...
      <widget_page>
        ...
        <file_box>
          <name>Plot stem</name>
          <value>Plot/LS/{cell_value} mtf</value>
        </file_box>
        <tick_box>
        ...
        <file_box>
          <name>Plot stem</name>
          <value>Plot/XS/{cell_value} mtf</value>
        </file_box>
        <tick_box>
          <name>Clean plot model(s) beforehand</name>
          <value>true</value>
      ...
      <widget_page>
        ...
        <input_box>
          ...
          <value>{prefix}/{cell_value} tps</value>
        </input_box>
        <input_box>
          <name>Interval</name>
          <value>5</value>
    ...
    <run_button>
      ...
      <Label>
        <Name>RUN {cell_value} mtf FILE</Name>
        <Active>true</Active>
        <Continue_on_failure>false</Continue_on_failure>
        <Uses_parameters>false</Uses_parameters>
        <Interactive>false</Interactive>
      ...
      <Function>
        <Name>Recalc {cell_value} mtf</Name>
        <Active>true</Active>
        <Continue_on_failure>false</Continue_on_failure>
        <Uses_parameters>false</Uses_parameters>
        <Interactive>false</Interactive>
