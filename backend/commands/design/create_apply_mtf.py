...
def create_apply_mtf_command(prefix: str, cell_value: str) -> List[str]:
    ...
    return [
        ...
        '        <file_box>',
        '          <name>MTF file</name>',
        f'          <value>{cell_value} mtf.mtf</value>',
        '        </file_box>',
        '        <tick_box>',
        ...
        '          <name>Reference</name>',
        '          <value>',
        f'            <cell_value>{prefix}/{cell_value}</cell_value>',
        '            <model_id></model_id>',
        f'            <name>{cell_value}</name>',
        '            <id>15222</id>',
        '          </value>',
        '        </select_box>',
        '        <select_box>',
        ...
        f'          <value>volumes {cell_value} mtf.rpt</value>',
        '        </file_box>',
        '      </widget_page>',
        '      <widget_page>',
        '        <name>Models</name>',
        ...
        '          </columns>',
        '          <data>',
        f'            <r><c>{prefix}/{cell_value} Strs</c><c>{prefix}/{cell_value} Sctn</c><c>red</c></r>',
        '            <r><c></c><c></c><c></c></r>',
        '            <r><c></c><c></c><c></c></r>',
        '            <r><c></c><c></c><c></c></r>',
        '            <r><c></c><c></c><c></c></r>',
        ...
        f'          <value>{prefix}/{cell_value} Poly</value>',
        '        </input_box>',
        '        <input_box>',
        '          <name>Model for road boundary</name>',
        f'          <value>{prefix}/{cell_value} Bdy</value>',
        '        </input_box>',
        '      </widget_page>',
        '      <widget_page>',
        '        <name>Misc</name>',
        ...
        f'          <value>tin/tin {cell_value} mtf</value>',
        '        </input_box>',
        '        <tick_box>',
        ...
        '        <input_box>',
        '          <name>Model for polygons</name>',
        f'          <value>Apply/VIS Depth Polygons/{cell_value} mtf</value>',
        '        </input_box>',
        '        <grid_box>',
        ...
        f'          <value>Apply/Sections/Filtered/{cell_value} mtf</value>',
        '        </input_box>',
        '        <input_box>',
        ...
        '        <file_box>',
        '          <name>Plot stem</name>',
        f'          <value>Plot/LS/{cell_value} mtf</value>',
        '        </file_box>',
        '        <tick_box>',
        ...
        '        <file_box>',
        '          <name>Plot stem</name>',
        f'          <value>Plot/XS/{cell_value} mtf</value>',
        '        </file_box>',
        '        <tick_box>',
        '          <name>Clean plot model(s) beforehand</name>',
        '          <value>true</value>',
        ...
        f'          <value>{prefix}/{cell_value} tps</value>',
        '        </input_box>',
        '        <input_box>',
        '          <name>Interval</name>',
        '          <value>5</value>',
